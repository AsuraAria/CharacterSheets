 ...
 * Cela permet d'éviter un cast lorsque l'on veut appeler les méthodes définies dans la classe abstraite {@link AbstractGUI}.
 *
 * @author Louri */
public class GUILoader<T extends AbstractGUI> extends FXMLLoader {
